...
public abstract class TransfertComposite {
  public interface Requires {
  }
  
  public interface Component extends TransfertComposite.Provides {
  }
  ...
  public interface Provides {
     ...
     * 
     */
    public InterfaceClient unServiceTransfer();
  }
  ...
  public static class ComponentImpl implements TransfertComposite.Component, TransfertComposite.Parts {
    private final TransfertComposite.Requires bridge;
    
    private final TransfertComposite implementation;
    ...
    private void init_client() {
      ...
      if (this.implem_client == null) {
      	throw new RuntimeException("make_client() in definitionsComposants.TransfertComposite should not return null.");
      }
    ...
    private void init_server() {
      ...
      if (this.implem_server == null) {
      	throw new RuntimeException("make_server() in definitionsComposants.TransfertComposite should not return null.");
      }
    ...
    protected void init_unServiceTransfer() {
      // nothing to do here
    }
    
    protected void initProvidedPorts() {
      init_unServiceTransfer();
    }
    
    public ComponentImpl(final TransfertComposite implem, final TransfertComposite.Requires b, final boolean doInits) {
      this.bridge = b;
    ...
    private final class BridgeImpl_client implements ComposantClientTransfert.Requires {
      public final InterfaceServer unServer() {
        return TransfertComposite.ComponentImpl.this.server().
        unService()
        ;
      }
    }
  ...
  private TransfertComposite.ComponentImpl selfComponent;
   ...
   * 
   */
  protected TransfertComposite.Provides provides() {
   ...
   * 
   */
  protected TransfertComposite.Requires requires() {
    assert this.selfComponent != null: "This is a bug.";
    if (!this.init) {
   ...
   * 
   */
  protected TransfertComposite.Parts parts() {
    assert this.selfComponent != null: "This is a bug.";
    if (!this.init) {
   ...
   * 
   */
  public synchronized TransfertComposite.Component _newComponent(final TransfertComposite.Requires b, final boolean start) {
    if (this.init) {
    	throw new RuntimeException("This instance of TransfertComposite has already been used to create a component, use another one.");
    }
    this.init = true;
    TransfertComposite.ComponentImpl  _comp = new TransfertComposite.ComponentImpl(this, b, true);
    if (start) {
    	_comp.start();
    }
    return _comp;
   ...
   * 
   */
  public TransfertComposite.Component newComponent() {
    return this._newComponent(new TransfertComposite.Requires() {}, true);
  }
}
